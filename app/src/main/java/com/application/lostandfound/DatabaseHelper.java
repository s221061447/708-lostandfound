...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE lost_and_found (id INTEGER PRIMARY KEY AUTOINCREMENT, lostOrFound TEXT, name TEXT, number INTEGER, description TEXT, location TEXT, date TEXT)");
    }
    ...
    public Boolean insertItem(String name, String lostOrFound, String number, String description, String location, String date) {
